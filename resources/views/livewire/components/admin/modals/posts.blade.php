...
{{-- Restore Post Modal --}}
<div wire:ignore.self class="modal fade" id="restorePostModal" aria-hidden="true" aria-labelledby="restorePostModalLabel" tabindex="-1">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="restorePostModalLabel">Restore Post</h5>
          <button type="button" wire:click="cancel" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form wire:submit.prevent="restore">
            <div class="modal-body text-center">
                @csrf
                <h4>Are you sure you want to restore this post ? </h4>
                <p>{{$title}}</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"  wire:click="cancel">Close</button>
                <button type="submit" class="btn btn-dark">Yes Restore Post !</button>
            </div>
        </form>
      </div>
    </div>
